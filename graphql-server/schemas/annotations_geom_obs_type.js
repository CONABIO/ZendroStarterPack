...
type Annotations_geom_obs_typeEdge{
  ...
  type Query {
    ...
    validateAnnotations_geom_obs_typeForCreation( classified_by: String, classification_method: String, observation_type: String, confidence: Float, geometry: GeometryCollection, video_frame_num: Int, frequency_min: Float, frequency_max: Float, time_min: Float, time_max: Float, updatedAt: DateTime, createdAt: DateTime , addFileTo:ID, addUserTo:ID, addPipeline_annotation:ID   , skipAssociationsExistenceChecks:Boolean = false): Boolean!
    validateAnnotations_geom_obs_typeForUpdating(id: ID!, classified_by: String, classification_method: String, observation_type: String, confidence: Float, geometry: GeometryCollection, video_frame_num: Int, frequency_min: Float, frequency_max: Float, time_min: Float, time_max: Float, updatedAt: DateTime, createdAt: DateTime , addFileTo:ID, removeFileTo:ID , addUserTo:ID, removeUserTo:ID , addPipeline_annotation:ID, removePipeline_annotation:ID    , skipAssociationsExistenceChecks:Boolean = false): Boolean!
  ...
  type Mutation {
    addAnnotations_geom_obs_type( classified_by: String, classification_method: String, observation_type: String, confidence: Float, geometry: GeometryCollection, video_frame_num: Int, frequency_min: Float, frequency_max: Float, time_min: Float, time_max: Float, updatedAt: DateTime, createdAt: DateTime , addFileTo:ID, addUserTo:ID, addPipeline_annotation:ID   , skipAssociationsExistenceChecks:Boolean = false): annotations_geom_obs_type!
    updateAnnotations_geom_obs_type(id: ID!, classified_by: String, classification_method: String, observation_type: String, confidence: Float, geometry: GeometryCollection, video_frame_num: Int, frequency_min: Float, frequency_max: Float, time_min: Float, time_max: Float, updatedAt: DateTime, createdAt: DateTime , addFileTo:ID, removeFileTo:ID , addUserTo:ID, removeUserTo:ID , addPipeline_annotation:ID, removePipeline_annotation:ID    , skipAssociationsExistenceChecks:Boolean = false): annotations_geom_obs_type!
