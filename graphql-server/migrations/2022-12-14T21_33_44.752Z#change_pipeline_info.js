    ...
    up: async (zendro) => {
        try {
            ...
            await storageHandler.getQueryInterface()
                .removeColumn('pipeline_infos', 'commit_dvc_of_data_ref');
            await storageHandler.getQueryInterface()
                .addColumn('pipeline_infos', 'name', {
                    type: Sequelize[dict['String']]
                });
            await storageHandler.getQueryInterface()
                .addColumn('pipeline_infos', 'last_execution', {
                    type: Sequelize[dict['DateTime']]
                });
            await storageHandler.getQueryInterface()
                .addColumn('pipeline_infos', 'execution_params', {
