    ...
    up: async (zendro) => {
        try {
            ...
            await storageHandler.getQueryInterface()
                .removeColumn('annotations_geom_obs_types', 'frequency_min');
            await storageHandler.getQueryInterface()
                .removeColumn('annotations_geom_obs_types', 'frequency_max');
            await storageHandler.getQueryInterface()
                .removeColumn('annotations_geom_obs_types', 'time_min');
            await storageHandler.getQueryInterface()
                .removeColumn('annotations_geom_obs_types', 'time_max');
