...
/**
 * ecosystem.prototype.unique_node - Return associated record
 *
 * @param  {object} search       Search argument to match the associated record
 * @param  {object} context Provided to every resolver holds contextual information like the resquest query and user info.
 * @return {type}         Associated record
 */
ecosystem.prototype.unique_node = async function({
    search
}, context) {
...
ecosystem.prototype.add_unique_node = async function(input, benignErrorReporter) {
    await ecosystem.add_node_id(this.getIdValue(), input.addUnique_node, benignErrorReporter);
...
ecosystem.prototype.remove_unique_node = async function(input, benignErrorReporter) {
    if (input.removeUnique_node == this.node_id) {
        await ecosystem.remove_node_id(this.getIdValue(), input.removeUnique_node, benignErrorReporter);
        this.node_id = null;
    }
}
...
async function countAllAssociatedRecords(id, context) {
    ...
    promises_to_one.push(ecosystem.unique_node({}, context));
...
module.exports = {
    ...
    /**
     * bulkAssociateEcosystemWithNode_id - bulkAssociaton resolver of given ids
     *
     * @param  {array} bulkAssociationInput Array of associations to add , 
     * @param  {object} context Provided to every resolver holds contextual information like the resquest query and user info.
     * @return {string} returns message on success
     */
    bulkAssociateEcosystemWithNode_id: async function(bulkAssociationInput, context) {
        let benignErrorReporter = new errorHelper.BenignErrorReporter(context);
        ...
        return await ecosystem.bulkAssociateEcosystemWithNode_id(bulkAssociationInput.bulkAssociationInput, benignErrorReporter);
    },
    /**
     * bulkDisAssociateEcosystemWithNode_id - bulkDisAssociaton resolver of given ids
     *
     * @param  {array} bulkAssociationInput Array of associations to remove , 
     * @param  {object} context Provided to every resolver holds contextual information like the resquest query and user info.
     * @return {string} returns message on success
     */
    bulkDisAssociateEcosystemWithNode_id: async function(bulkAssociationInput, context) {
        let benignErrorReporter = new errorHelper.BenignErrorReporter(context);
        // if specified, check existence of the unique given ids
        if (!bulkAssociationInput.skipAssociationsExistenceChecks) {
            await helper.validateExistence(helper.unique(bulkAssociationInput.bulkAssociationInput.map(({
        ...
        return await ecosystem.bulkDisAssociateEcosystemWithNode_id(bulkAssociationInput.bulkAssociationInput, benignErrorReporter);
    },
