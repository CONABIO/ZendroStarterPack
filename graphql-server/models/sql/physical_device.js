...
module.exports = class physical_device extends Sequelize.Model {
     ...
     * @return {object} The requested record as an object with the type physical_device, or an error object if the validation after reading fails
    ...
    /**
     * base64Encode - Encode  physical_device to a base 64 String
     *
     * @return {string} The physical_device object, encoded in a base 64 String
     */
    base64Encode() {
    ...
    /**
     * stripAssociations - Instance method for getting all attributes of physical_device.
     *
     * @return {object} The attributes of physical_device in object form
     */
    stripAssociations() {
    ...
    /**
     * externalIdsArray - Get all attributes of physical_device that are marked as external IDs.
     *
     * @return {Array<String>} An array of all attributes of physical_device that are marked as external IDs
     */
    ...
    /**
     * externalIdsObject - Get all external IDs of physical_device.
     *
