...
module.exports = class device_catalog extends Sequelize.Model {
     ...
     * @return {object} The requested record as an object with the type device_catalog, or an error object if the validation after reading fails
    ...
    /**
     * base64Encode - Encode  device_catalog to a base 64 String
     *
     * @return {string} The device_catalog object, encoded in a base 64 String
     */
    base64Encode() {
    ...
    /**
     * stripAssociations - Instance method for getting all attributes of device_catalog.
     *
     * @return {object} The attributes of device_catalog in object form
     */
    stripAssociations() {
    ...
    /**
     * externalIdsArray - Get all attributes of device_catalog that are marked as external IDs.
     *
     * @return {Array<String>} An array of all attributes of device_catalog that are marked as external IDs
     */
    ...
    /**
     * externalIdsObject - Get all external IDs of device_catalog.
     *
