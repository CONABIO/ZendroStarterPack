...
module.exports = class institution extends Sequelize.Model {
     ...
     * @return {object} The requested record as an object with the type institution, or an error object if the validation after reading fails
    ...
    /**
     * base64Encode - Encode  institution to a base 64 String
     *
     * @return {string} The institution object, encoded in a base 64 String
     */
    base64Encode() {
    ...
    /**
     * stripAssociations - Instance method for getting all attributes of institution.
     *
     * @return {object} The attributes of institution in object form
     */
    stripAssociations() {
    ...
    /**
     * externalIdsArray - Get all attributes of institution that are marked as external IDs.
     *
     * @return {Array<String>} An array of all attributes of institution that are marked as external IDs
     */
    ...
    /**
     * externalIdsObject - Get all external IDs of institution.
     *
